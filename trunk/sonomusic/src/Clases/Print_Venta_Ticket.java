...
public class Print_Venta_Ticket {
    ...
    public void generar(int venta) {
        ...
        try {
            ...
            String c_cabezera = "select v.idalmacen, a.nom_alm, a.dir_alm, a.ruc, a.raz_soc, a.telefono1, a.telefono2, td.desc_tipd, v.fec_ped, v.est_ped, "
                    + "v.idtipo_doc, v.serie_doc, v.nro_doc, c.dir_per, v.cli_doc, v.cli_nom, v.total "
                    + "from pedido as v "
