...
public class frm_reg_venta extends javax.swing.JInternalFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(btn_reg, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
            ...
            if (txt_id.getText().length() != 0) {
                ...
                try {
                    ...
                    if (rs1.next()) {
                        ...
                        if (cant_dis > 0) {
                            Integer copiado = 0;
                            double oferta_prod = ofe.precio_oferta(frm_menu.alm.getId(), rs1.getInt("idProductos"));
                            if (filas_tabla > 0) {
    ...
    private void cbx_tipdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cbx_tipdKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            //si documento de venta es nota de venta
